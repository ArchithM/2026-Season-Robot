 ...
 * Unlike the built-in WaitCommand, this class accepts a supplier for the
 * duration (especially useful when combined with LoggedTunableNumber).
 */
public class SuppliedWaitCommand extends Command {
     ...
     *
     * @param seconds
     *            A supplier for the time to wait, in seconds
     */

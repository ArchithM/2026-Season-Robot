...
public class PIDs {
    public static final LoggedTunableNumber turretKp = new LoggedTunableNumber("Turret/kP").initDefault(10);
    ...
    public static final LoggedTunableNumber turretKv = new LoggedTunableNumber("Turret/kV").initDefault(6.0897);
    public static final LoggedTunableNumber turretKa = new LoggedTunableNumber("Turret/kA").initDefault(0.54764);
